...
public:
  ...
  ValuesListProperty(const ValuesListProperty&) = delete;
  ValuesListProperty& operator=(const ValuesListProperty&) = delete;
  ValuesListProperty(ValuesListProperty&&) = delete;
  ValuesListProperty& operator=(ValuesListProperty&&) = delete;
